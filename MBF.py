...
kartu2d = random.choice(["Lu ganteng bwank tapi sayang kek kontl ", "Wkwkwkwk [ AKU CINTA DIA DIA NGGAK CINTA SAMA GUWA GIMANA BANG ]","AHAHAHAHHA BANYAK KANG RECOD AWAS BANG "])
...
def menu():
    ...
    if pp in ["1","01"]:
      massal()
        ...
        cek_hasil()
    else:print(f"{B} | \n");print(f"{P}[•]{M} Isi dengan benar ");menu()
